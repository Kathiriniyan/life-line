    ...
    >
          ...
          {campaign.isEmergency && (
            <>
              <span className="text-red-600">
                <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="#fee2e2" /><path d="M12 8v4m0 4h.01" stroke="#dc2626" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
              </span>
      ...
      <div className="flex justify-between">
        <div className="mb-2">
          ...
          <span className="font-bold text-sm text-gray-800">LKR {campaign.goal_amount.toLocaleString()}</span>
        </div>
